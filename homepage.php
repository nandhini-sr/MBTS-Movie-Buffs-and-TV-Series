...
<body>
      ...
      <?php
       ...
       ?>
       <a href="index.php" style="display:inline; float:right; margin-top: -10px; margin-right: 30px"><button class="btn btn-warning" style="display:inline">Log out</button></a>
       <br>
       <hr>
...
<div class="modal fade" id="basicExampleModal" role="dialog">
  <div class="modal-dialog" role="document">
    ...
    <script type="text/javascript" src="jquery/jqueryHome6.js"></script>
